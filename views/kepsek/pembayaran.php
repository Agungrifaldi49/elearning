...
<div class="container-fluid">
    ...
    <?php if ($global['total_target'] <= 0): ?>
        <div class="card border-0 shadow-sm rounded-4 bg-white p-5 text-center mb-4">
            ...
            <h5 class="fw-bold text-dark mb-1">Belum Ada Data Pembayaran Terdata</h5>
            <p class="text-muted small mb-0" style="max-width: 580px; margin: 0 auto;">
                Data penerimaan SPP dan iuran pendidikan saat ini belum dimuat dari sistem pembayaran sekolah oleh Bagian Tata Usaha / Admin. Grafik realisasi dan kepatuhan rombel kelas akan aktif otomatis setelah data ditarik.
            </p>
        </div>
    <?php else: ?>
