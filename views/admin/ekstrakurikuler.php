                ...
                <div class="col-12 col-lg-4">
                    <div class="card border-0 rounded-4 shadow-sm bg-white p-4 h-100">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <div class="d-flex align-items-center justify-content-center rounded-4 shadow-sm flex-shrink-0" style="width: 58px; height: 58px; background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%);">
