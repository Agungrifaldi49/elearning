                        ...
                        ?>
                            <div class="topic-card-item" data-topic-id="<?= $t['id'] ?>" data-visibility="<?= $t['visibility'] ?? 'public' ?>">
                                <div class="forum-topic-card p-4 rounded-4 shadow-sm bg-white border">
                                    ...
                                    ?>
                                        <div class="mb-3">
                                            <div class="forum-image-preview-wrapper shadow-sm" style="position: relative; width: 100%; max-width: 500px; height: 220px; max-height: 220px; border-radius: 16px; overflow: hidden; cursor: pointer; background: #f8fafc; border: 1px solid #e2e8f0;" onclick="openLightboxModal('<?= $imgPath ?>', '<?= htmlspecialchars(addslashes($t['judul'])) ?>')">
                                                ...
                                                <div class="forum-image-overlay" style="font-size:0.8rem;">
