    ...
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs border-bottom-0 mb-3" id="absensiTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active fw-bold px-4 py-2.5 rounded-top-3" id="siswa-tab" data-bs-toggle="tab" data-bs-target="#siswa-panel" type="button" role="tab" aria-controls="siswa-panel" aria-selected="true">
                    <i class="bi bi-people-fill text-primary me-2"></i>Rekap Presensi Siswa (KBM)
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link fw-bold px-4 py-2.5 rounded-top-3" id="guru-tab" data-bs-toggle="tab" data-bs-target="#guru-panel" type="button" role="tab" aria-controls="guru-panel" aria-selected="false">
        ...
        <div class="tab-content" id="absensiTabContent">
            ...
            <div class="tab-pane fade show active" id="siswa-panel" role="tabpanel" aria-labelledby="siswa-tab">
            ...
            <div class="tab-pane fade" id="guru-panel" role="tabpanel" aria-labelledby="guru-tab">
                <div class="card card-custom p-4 mb-4 border-0 rounded-4 shadow-sm bg-white">
                    <form action="<?= $formAbsensiUrl ?>" method="GET" class="row g-3 align-items-end mb-4">
                        <input type="hidden" name="url" value="<?= $isAdminRoute ? 'admin/absensi' : 'guru/absensi' ?>">
                        <div class="col-md-8">
                            <label class="form-label small fw-semibold text-dark"><i class="bi bi-calendar3 text-success me-1"></i> Filter Tanggal Presensi Guru</label>
                            <input type="date" name="tanggal" class="form-control rounded-3" value="<?= htmlspecialchars($tanggal) ?>">
                        </div>
                        <div class="col-md-4">
                            <button type="submit" class="btn btn-success rounded-3 w-100 fw-bold"><i class="bi bi-search me-1"></i> Filter Data Guru</button>
                        </div>
                    </form>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                        ...
                        <div class="d-flex gap-2">
                            <span class="badge bg-success-subtle text-success border border-success px-3 py-2">
                                Hadir: <?= count(array_filter($recapGuru ?? [], fn($g) => !empty($g['waktu_masuk']) || !empty($g['waktu_hadir']))) ?> Guru
                            </span>
                            <span class="badge bg-secondary-subtle text-dark border px-3 py-2">
                                Total: <?= count($recapGuru ?? []) ?> Guru
                            </span>
                        </div>
                    </div>
