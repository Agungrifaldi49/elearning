...
<div class="container-fluid">
    ...
    <div class="profil-hero-banner p-4 p-md-5 mb-4">
        <div class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <div>
                <h3 class="fw-bold mb-1 text-white" style="letter-spacing: -0.5px;">Profil Pengguna & Keamanan Akun Guru</h3>
    ...
    <form action="<?= BASE_URL ?>index.php?url=guru/profil" method="POST" enctype="multipart/form-data" id="profileForm">
        <?= Security::csrfField() ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-4">
                <div class="card border-0 rounded-4 shadow-sm p-4 text-center bg-white">
                    <div class="position-relative d-inline-block mb-3">
                        ...
                        <?php else: ?>
                            <div id="avatarInitBox" class="avatar-initial-box">
                                <?= strtoupper(substr($user['full_name'] ?? 'G', 0, 1)) ?>
                            </div>
                    ...
                    <p class="text-primary fw-bold small mb-2"><i class="bi bi-person-video3 me-1"></i><?= htmlspecialchars($user['role_name']) ?></p>
                    
                    <div class="d-flex justify-content-center align-items-center gap-2 mb-3">
                        <span class="badge bg-success-subtle text-success border border-success-subtle rounded-pill px-3 py-1 fw-bold">
                            <i class="bi bi-check-circle-fill me-1"></i>Akun Verified
                        </span>
            ...
            <div class="col-12 col-lg-8">
                <div class="card border-0 rounded-4 shadow-sm p-4 p-md-5 bg-white">
                    <h6 class="fw-bold text-dark mb-3 pb-2 border-bottom d-flex align-items-center gap-2">
                        <i class="bi bi-person-lines-fill text-primary"></i> Informasional Data Diri Guru
                    </h6>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-md-6">
                            <label class="form-label small fw-bold text-dark">Username (NIP)</label>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="no_telepon" class="form-control rounded-3" value="<?= htmlspecialchars($guru['no_telepon'] ?? '') ?>" placeholder="Contoh: 081234567890">
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label small fw-bold text-dark">Jenis Kelamin</label>
                            <select name="jenis_kelamin" class="form-select rounded-3">
                                <option value="L" <?= ($guru['jenis_kelamin'] ?? 'L') === 'L' ? 'selected' : '' ?>>Laki-Laki</option>
                                <option value="P" <?= ($guru['jenis_kelamin'] ?? 'L') === 'P' ? 'selected' : '' ?>>Perempuan</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label small fw-bold text-dark">NIP</label>
                            <input type="text" class="form-control rounded-3 bg-light" value="<?= htmlspecialchars($guru['nip'] ?? '-') ?>" readonly tabindex="-1">
                        </div>
                        <div class="col-12">
                            <label class="form-label small fw-bold text-dark">Alamat Tempat Tinggal</label>
                            <textarea name="alamat" class="form-control rounded-3" rows="2" placeholder="Alamat lengkap..."><?= htmlspecialchars($guru['alamat'] ?? '') ?></textarea>
                        </div>
                    </div>
