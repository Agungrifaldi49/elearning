...
<!-- Navbar Landing Page -->
<nav class="navbar navbar-expand-lg navbar-dark landing-navbar fixed-top py-3 shadow-sm" id="mainNavbar">
    <div class="container">
        <a class="navbar-brand fw-bold d-flex align-items-center gap-2" href="#">
            ...
            <?php endif; ?>
            <span class="fs-5 tracking-tight text-white"><?= htmlspecialchars($schoolName) ?></span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navPublic">
            <ul class="navbar-nav ms-auto me-lg-4 gap-1 py-2 py-lg-0">
                <li class="nav-item"><a class="nav-link text-white fw-medium px-3" href="#profil"><i class="bi bi-info-circle me-1"></i> Profil</a></li>
                <li class="nav-item"><a class="nav-link text-white fw-medium px-3" href="#fitur"><i class="bi bi-stars me-1"></i> Fitur LMS</a></li>
                <li class="nav-item"><a class="nav-link text-white fw-medium px-3" href="#jurusan"><i class="bi bi-award me-1"></i> Jurusan</a></li>
                <li class="nav-item"><a class="nav-link text-white fw-medium px-3" href="#guru"><i class="bi bi-people me-1"></i> Pengajar</a></li>
                <li class="nav-item"><a class="nav-link text-white fw-medium px-3" href="#kontak"><i class="bi bi-geo-alt me-1"></i> Kontak</a></li>
            </ul>
...
<!-- Hero Banner Section -->
<section class="landing-hero text-white pt-5 pb-5 mt-5 position-relative">
        ...
        <div class="row align-items-center gy-5">
            <div class="col-lg-7 text-center text-lg-start">
                <div class="d-inline-flex align-items-center gap-2 bg-white bg-opacity-10 backdrop-blur px-3 py-2 rounded-pill mb-4 border border-white border-opacity-25 shadow-sm">
                    <span class="badge bg-warning text-dark fw-bold rounded-pill"><i class="bi bi-lightning-charge-fill me-1"></i> LMS v2.5</span>
                ...
                <p class="lead text-white-50 mb-4 pe-lg-4 fw-normal">
            ...
            <div class="col-lg-5 text-center">
                <div class="glass-card p-4 p-md-5 rounded-4 border border-white border-opacity-25 shadow-lg text-white">
                    <div class="bg-warning bg-opacity-20 text-warning d-inline-flex p-3 rounded-circle mb-3 border border-warning border-opacity-25">
                        <i class="bi bi-laptop display-4"></i>
                    </div>
                    <h3 class="fw-bold mb-2"><?= htmlspecialchars($settings['landing_hero_card_title'] ?? 'KBM Digital Terpadu') ?></h3>
                    ...
                    <div class="row g-2 text-start pt-2 border-top border-white border-opacity-10">
                        <div class="col-6">
    ...
    <div class="container">
        <div class="row g-4 text-center">
            <div class="col-6 col-md-3">
                <div class="p-2">
                    <h2 class="fw-extrabold text-primary mb-0">100%</h2>
                    <span class="small text-muted fw-medium">Digital Learning Platform</span>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="p-2">
                    <h2 class="fw-extrabold text-success mb-0"><?= count($jurusanList ?? []) ?>+</h2>
                    <span class="small text-muted fw-medium">Program Keahlian</span>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="p-2">
                    <h2 class="fw-extrabold text-warning mb-0"><?= count($guruList ?? []) ?>+</h2>
                    <span class="small text-muted fw-medium">Guru & Pengajar Professional</span>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="p-2">
                    <h2 class="fw-extrabold text-danger mb-0">24/7</h2>
                    <span class="small text-muted fw-medium">Akses KBM & Ujian Online</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card-custom h-100 p-4 border-start border-4 border-primary shadow-sm bg-white">
                            <div class="d-flex align-items-center gap-2 mb-2">
                                ...
                                <h5 class="fw-bold text-primary mb-0"><?= htmlspecialchars($settings['landing_visi_title'] ?? 'Visi Utama') ?></h5>
                            </div>
                            <div class="text-secondary small landing-misi-content">
                                <?= $visiContent ?>
                            </div>
                        </div>
                    </div>

                    <!-- Misi Card (Supports HTML lists, bold, italic, underline) -->
                    <div class="col-12 col-md-6">
                        <div class="card-custom h-100 p-4 border-start border-4 border-success shadow-sm bg-white">
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <div class="bg-success text-white rounded-circle d-inline-flex align-items-center justify-content-center" style="width:36px; height:36px;">
                                    <i class="bi bi-bullseye"></i>
                                </div>
                                <h5 class="fw-bold text-success mb-0"><?= htmlspecialchars($settings['landing_misi_title'] ?? 'Misi Presisi') ?></h5>
                            </div>
                            <div class="text-secondary small landing-misi-content">
                                <?= $misiContent ?>
                            </div>
...
<section id="fitur" class="py-5 bg-white">
    <div class="container py-4">
        <div class="text-center max-w-700 mx-auto mb-5">
            ...
            <h2 class="fw-bold display-6 mb-2">Fitur Unggulan E-Learning</h2>
        ...
        <div class="row g-4">
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card card-custom card-hover-effect h-100 p-4 text-center border-0">
                    ...
                    <h5 class="fw-bold mb-2">Modul & KBM Digital</h5>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card card-custom card-hover-effect h-100 p-4 text-center border-0">
                    ...
                    <h5 class="fw-bold mb-2">CBT & Quiz Online</h5>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card card-custom card-hover-effect h-100 p-4 text-center border-0">
                    ...
                    <h5 class="fw-bold mb-2">Absensi QR Code</h5>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card card-custom card-hover-effect h-100 p-4 text-center border-0">
                    ...
                    <h5 class="fw-bold mb-2">E-Rapor & Sertifikat</h5>
...
<section id="jurusan" class="py-5 bg-light">
    <div class="container py-4">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bold display-6">Pilihan Jurusan Unggulan</h2>
            ...
            <?php if (!empty($jurusanList)): ?>
                <?php foreach ($jurusanList as $j): ?>
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="card card-custom card-hover-effect h-100 p-4 text-center bg-white">
                            ...
                            <h5 class="fw-bold mb-2 text-dark"><?= htmlspecialchars($j['nama_jurusan']) ?></h5>
...
<section id="guru" class="py-5 bg-white">
    <div class="container py-4">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bold display-6">Guru & Pengajar Professional</h2>
        ...
        <div class="row g-4">
            <?php if (!empty($guruList)): ?>
                <?php foreach (array_slice($guruList, 0, 8) as $g): ?>
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="card card-custom card-hover-effect h-100 text-center overflow-hidden border-0 bg-light">
                            <div class="pt-4 px-4">
                            ...
                            <div class="card-body pt-1">
                                <h6 class="fw-bold text-dark mb-1 fs-6"><?= htmlspecialchars($g['nama_lengkap']) ?></h6>
    ...
    <div class="container py-4">
        <div class="row gy-4">
            <div class="col-lg-5">
                ...
                <h2 class="fw-bold display-6 mb-4"><?= htmlspecialchars($settings['landing_kontak_title'] ?? 'Lokasi & Kontak Sekolah') ?></h2>
                
                <div class="card-custom p-3 mb-3 d-flex align-items-center gap-3 bg-white border-0">
                ...
                <div class="card-custom p-3 d-flex align-items-center gap-3 bg-white border-0">
            ...
            <div class="col-lg-7">
                <div class="card-custom p-2 bg-white h-100">
                    <div class="ratio ratio-16x9 rounded-4 overflow-hidden shadow-sm h-100">
        ...
        <div class="row gy-4 mb-4">
            <div class="col-lg-5">
                <div class="d-flex align-items-center gap-2 mb-3">
                    <?php if ($logoUrl): ?>
                        <img src="<?= htmlspecialchars($logoUrl) ?>" alt="Logo" class="rounded-3 bg-white p-1" style="height:36px;">
                    <?php else: ?>
                        <i class="bi bi-mortarboard-fill fs-3 text-warning"></i>
                    <?php endif; ?>
                    <h5 class="fw-bold text-warning mb-0"><?= htmlspecialchars($schoolName) ?></h5>
                </div>
            ...
            <div class="col-6 col-lg-4 text-lg-end">
                <h6 class="fw-bold text-white mb-3">Akses Portal</h6>
